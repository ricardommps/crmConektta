  ...
  function chartistCtrl($scope, $timeout, baConfig) {
    ...
    $scope.stackedBarData = {
      ...
      series: [
        ...
        [500000, 600000, 400000, 600000],
        [200000, 100000, 700000, 300000],
        [900000, 300000, 200000, 900000],
        [300000, 900000, 800000, 700000]
      ]
    };

    // _chartsPage.scss:69 (.ct-series-a .ct-bar)
    // _chartsPage.scss:78 (.ct-series-b .ct-bar)
